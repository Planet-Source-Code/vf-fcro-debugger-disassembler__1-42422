...
If ActiveThread = 0 Then MsgBox "All Threads Running!", vbExclamation, "Information!": NextB = 0: Exit Sub
Dim IsTrR As Long
IsTrR = IsRunningThread(ActiveThread)
If IsTrR = 1 Then Exit Sub
DISCOUNT = GetLastEip(ActiveThread)
NextB = 0
ReleaseShow 1
End Sub
...
SetParent Form1.hwnd, hwnd
SetParent Form8.hwnd, hwnd
SetParent Form12.hwnd, hwnd
...
Call GetBreakPoint(AdrR, IsValidBP)
If IsValidBP = 0 Then
AddBreakPoint AdrR, ISBPDisabled
List8.List(List8.ListIndex) = "*BP*"
Else
RemoveBreakPoint AdrR
...
Dim ICtc As String
If Way = 0 Then
TName = FindInModules(DISCOUNT, TA, TA2)
...
Dim IsValidBP As Byte
Call GetBreakPoint(LastEip, IsValidBP)
...
CTX = GetContext(ActiveThread)
ReadMem ActiveProcess, CTX.Eip
ActiveStackPosition = CTX.Esp
ActiveBasePosition = CTX.Ebp
